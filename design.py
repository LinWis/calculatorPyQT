...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/icons/icons/outline_calculate_white_24dp.png", QSize(), QIcon.Normal, QIcon.Off)
...
"border: none;")
        ...
        self.Layout_Button.addWidget(self.btn_plus, 3, 3, 1, 1)
        ...
        self.Layout_Button.addWidget(self.btn_C, 0, 0, 1, 1)
        ...
        self.Layout_Button.addWidget(self.btn_dot, 4, 2, 1, 1)
        ...
        self.btn_xz = QPushButton(self.centralwidget)
        self.btn_xz.setObjectName(u"btn_xz")
        sizePolicy2.setHeightForWidth(self.btn_xz.sizePolicy().hasHeightForWidth())
        self.btn_xz.setSizePolicy(sizePolicy2)
        self.btn_xz.setCursor(QCursor(Qt.PointingHandCursor))

        self.Layout_Button.addWidget(self.btn_xz, 4, 0, 1, 1)
        ...
        self.Layout_Button.addWidget(self.btn_CE, 0, 1, 1, 1)
        ...
        self.Layout_Button.addWidget(self.btn_backspace, 0, 2, 1, 1)

        self.btn_det = QPushButton(self.centralwidget)
        self.btn_det.setObjectName(u"btn_det")
        sizePolicy2.setHeightForWidth(self.btn_det.sizePolicy().hasHeightForWidth())
        self.btn_det.setSizePolicy(sizePolicy2)
        self.btn_det.setCursor(QCursor(Qt.PointingHandCursor))

        self.Layout_Button.addWidget(self.btn_det, 0, 3, 1, 1)

        self.btn_prod = QPushButton(self.centralwidget)
        self.btn_prod.setObjectName(u"btn_prod")
        sizePolicy2.setHeightForWidth(self.btn_prod.sizePolicy().hasHeightForWidth())
        self.btn_prod.setSizePolicy(sizePolicy2)
        self.btn_prod.setCursor(QCursor(Qt.PointingHandCursor))

        self.Layout_Button.addWidget(self.btn_prod, 1, 3, 1, 1)
        ...
        self.Layout_Button.addWidget(self.btn_minus, 2, 3, 1, 1)
        ...
        self.Layout_Button.addWidget(self.btn_equal, 4, 3, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
...
#endif // QT_CONFIG(shortcut)
        self.btn_xz.setText(QCoreApplication.translate("MainWindow", u"+/-", None))
...
#endif // QT_CONFIG(shortcut)
        self.btn_det.setText(QCoreApplication.translate("MainWindow", u"/", None))
#if QT_CONFIG(shortcut)
        self.btn_det.setShortcut(QCoreApplication.translate("MainWindow", u"/", None))
#endif // QT_CONFIG(shortcut)
        ...
        for sc in ('=', 'Enter', 'Return'):
            QShortcut(sc, self.btn_equal).activated.connect(self.btn_dot.animateClick)
